class Student {
   ...
   var s1 = new Student('Thanh', 8, 0, [{title: 'toán', mark: 6}, {title: 'lý', mark: 7}])
   var s2 = new Student('Thành', 5, 0, [{title: 'toán', mark: 7}, {title: 'lý', mark: 4}])
   var s3 = new Student('Liên', 4.5, 1, [{tiile: 'toán', mark: 4}, {title: 'lý', mark: 5}])
   var s4 = new Student('Ngọc', 9, 1, [{title: 'toán', mark: 8}, {title: 'lý', mark: 6}])
   var s5 = new Student('Tùng', 8.5, 0, [{title: 'toán', mark: 8}, {title: 'lý', mark: 8}])
   var s6 = new Student('Huy', 8, 0, [{title: 'toán', mark: 9}, {title: 'lý', mark: 6}])
   var s7 = new Student('Thúy', 6, 1, [{title: 'toán', mark: 4}, {title: 'lý', mark: 9}])
   var s8 = new Student('Nguyên', 0, 0, [{title: 'toán', mark: 3}, {title: 'lý', mark: 0}])
   var s9 = new Student('Toàn', 7, 0, [{title: 'toán', mark: 7}, {title: 'lý', mark: 5}])
   var s10 = new Student('Tu', 0, 0, [{title: 'toán', mark: 2}, {title: 'lý', mark: 0}])
